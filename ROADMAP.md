...
7. We can safely manage and remove fctxs using the new cleanup actions (`rm-def`, `rm-files`, `rm-all`).
8. We can perform all supported cli actions using a terminal interactive screen / mode