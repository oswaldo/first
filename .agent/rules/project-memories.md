...
- **Workflow Rule**: Always rebuild the Scala.js project (`scala-cli package site ...`) before running the preview server, and always verify with the preview server before committing changes.
